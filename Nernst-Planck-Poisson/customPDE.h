...
private:
  ...
  double e = userInputs.get_model_constant_double("e");
  double z = userInputs.get_model_constant_double("z");
  double co = userInputs.get_model_constant_double("co");
  double eps = userInputs.get_model_constant_double("eps");
  double R = userInputs.get_model_constant_double("R");
  double T = userInputs.get_model_constant_double("T");
  double F = userInputs.get_model_constant_double("F");
